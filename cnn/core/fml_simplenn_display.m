function [info, str] = fml_simplenn_display(net, varargin)
% fork of VL_SIMPLENN_DISPLAY with appropriate handling of 
%   3d convolutions, max-pooling
%   however, all computations ignore 3rd dimension
%
...
for l = 1:numel(net.layers)
  ...
  switch ly.type
    ...
    case {'pool', 'pool3'} % FML addition
      info.support(1:2,l) = ly.pool(1:2) ;
    otherwise
